...
/* build-hook-start *//*00001*/try{process.env.NINJA_ENV=options.optimization.nodeEnv;}catch(e){}try { require('/Users/zaeem/.vscode/extensions/wallabyjs.console-ninja-1.0.541/out/buildHook/index.js').default({tool: 'webpack', checkSum: '20fd9da19927d5cd2d0b1cU0oAUk8AAwkBBFQBVF0BUwNWCAUF', mode: 'build', condition: true}); } catch(cjsError) { try { import('file:///Users/zaeem/.vscode/extensions/wallabyjs.console-ninja-1.0.541/out/buildHook/index.js').then(m => m.default.default({tool: 'webpack', checkSum: '20fd9da19927d5cd2d0b1cU0oAUk8AAwkBBFQBVF0BUwNWCAUF', mode: 'build', condition: true})).catch(esmError => {}) } catch(esmError) {}}/* build-hook-end */
